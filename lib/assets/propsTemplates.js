 ...
 */
const getTextAreaField = (label, name, value, className="") => {
  return `
    <label class="${className}">
      ${label}
...
const leafletFields = () => `
  <fieldset>
    ...
    ${getInputField("Latitute", "leaflet.latitute", initialSectionStates.leaflet.leaflet.latitute, "latitute")}
    ${getInputField("Longitude", "leaflet.longitude", initialSectionStates.leaflet.leaflet.longitude, "longitude")}
    ${getInputField("Zoom", "leaflet.zoom", initialSectionStates.leaflet.leaflet.zoom, "zoom")}
    ${getInputField("Container ID", "leaflet.containerId", initialSectionStates.leaflet.leaflet.containerId, "containerId")}
    ${getInputField("Container Height", "leaflet.containerHeight", initialSectionStates.leaflet.leaflet.containerHeight, "containerHeight")}
    <div class="markers-wrapper js-markers-wrapper">
      ${getInputField("Marker Title", "leaflet.markers[0].title", initialSectionStates.leaflet.leaflet.markers[0].title, "markerTitle")}
      ${getInputField("Marker Latitute", "leaflet.markers[0].latitute", initialSectionStates.leaflet.leaflet.markers[0].latitute, "markerLatitute")}
      ${getInputField("Marker Longitude", "leaflet.markers[0].longitude", initialSectionStates.leaflet.leaflet.markers[0].longitude, "markerLongitude")}
      ${getInputField("Marker Content Title", "leaflet.markers[0].content.title", initialSectionStates.leaflet.leaflet.markers[0].content.title, "markerContentTitle")}
      ${getTextAreaField("Marker Content Body", "leaflet.markers[0].content.body", initialSectionStates.leaflet.leaflet.markers[0].content.body, "markerContentBody")}
      ${getInputField("Marker Content Link", "leaflet.markers[0].content.link", initialSectionStates.leaflet.leaflet.markers[0].content.link, "markerContentLink")}
