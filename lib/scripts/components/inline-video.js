...
const inlineVideos = (function() {
  ...
  let allVideos = document.querySelectorAll(".js-inline-video");
  let allVideoWrappers = document.querySelectorAll(".js-inline-video-wrapper");
  let allPlayers = [];
  ...
  const init = function() {
    allVideos = document.querySelectorAll(".js-inline-video");
    allVideoWrappers = document.querySelectorAll(".js-inline-video-wrapper");
    allPlayers = [];
