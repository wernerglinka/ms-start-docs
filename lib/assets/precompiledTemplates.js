...
tasks.push(
function(callback) {
env.getTemplate("sections/head.njk", false, "pages.njk", false, function(t_2,t_1) {
if(t_2) { cb(t_2); return; }
callback(null,t_1);});
});
tasks.push(
...
tasks.push(
function(callback) {
env.getTemplate("sections/header.njk", false, "pages.njk", false, function(t_6,t_5) {
if(t_6) { cb(t_6); return; }
callback(null,t_5);});
});
tasks.push(
...
tasks.push(
function(callback) {
env.getTemplate("sections/footer.njk", false, "pages.njk", false, function(t_12,t_11) {
if(t_12) { cb(t_12); return; }
callback(null,t_11);});
});
tasks.push(
