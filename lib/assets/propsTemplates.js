...
const compositionText = () => `
  <fieldset>
    ...
    ${getCheckboxField("Has CTAs", "hasCtas", initialSectionStates["text"].hasCtas)}
  </fieldset>
`;
...
const compositionTextAudio = () => `
  <fieldset>
    <legend>Composition</legend>
    ${getCheckboxField("Is Reverse", "isReverse", initialSectionStates["text-audio"].isReverse)}
    ${getCheckboxField("Has CTAs", "hasCtas", initialSectionStates["text-audio"].hasCtas)}
    ${getCheckboxField("Has Image", "hasImage", initialSectionStates["text-audio"].hasImage)}
  </fieldset>
`;
...
const getFields = (templateName) => {
  return {
    ...
    lottie: lottieFields(),
    text: textFields(),
    "text-audio": `${compositionTextAudio()}${textFields()}${audioFields()}`,
