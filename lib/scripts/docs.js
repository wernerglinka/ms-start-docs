...
const docs = (function() {
  ...
  const updatePropsDisplay = function(templateName) {
    ...
    propsDisplay.innerHTML = getFields(templateName)['common'] + getFields(templateName)[templateName];
  ...
  const getSection = function(templateName) {
    ...
    const section = Object.assign({}, sectionWrapper(templateName), {params});
