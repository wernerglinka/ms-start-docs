...
output += "\n  ";
var t_2;
t_2 = runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "params")),"list")),"template");
...
output += "\n    ";
var t_4;
t_4 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "refData")),runtime.contextOrFrameLookup(context, frame, "source"));
frame.set("selection", t_4, true);
if(frame.topLevel) {
context.setVariable("selection", t_4);
}
if(frame.topLevel) {
context.addExport("selection", t_4);
}
output += "\n  ";
;
}
...
output += "\n    ";
var t_5;
t_5 = env.getFilter("getSelections").call(context, runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "refData")),runtime.contextOrFrameLookup(context, frame, "source")),runtime.contextOrFrameLookup(context, frame, "selections"));
frame.set("selection", t_5, true);
if(frame.topLevel) {
context.setVariable("selection", t_5);
}
if(frame.topLevel) {
context.addExport("selection", t_5);
}
output += "\n  ";
;
}
...
tasks.push(
function(callback) {
env.getTemplate("sections/particles/lists/" + runtime.contextOrFrameLookup(context, frame, "template") + ".njk", false, "page-sections/list.njk", true, function(t_7,t_6) {
...
output += "\n";
var t_2;
t_2 = runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "params")),"list")),"imageWidth");
