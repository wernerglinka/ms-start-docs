...
const ctasFields = (target) => `
  <fieldset class="cta-fields">
      <legend>CTAs</legend>
        ...
        <span class="add-cta js-add-cta">+</span>
    </fieldset>
`;
...
const leafletFields = () => `
  <fieldset>
    ...
    ${getInputField("Center X", "leaflet.centerX", initialSectionStates.leaflet.leaflet.centerX)}
    ${getInputField("Center Y", "leaflet.centerY", initialSectionStates.leaflet.leaflet.centerY)}
