...
tasks.push(
function(callback) {
env.getTemplate("sections/particles/text.njk", false, "page-sections/text-audio.njk", false, function(t_2,t_1) {
if(t_2) { cb(t_2); return; }
callback(null,t_1);});
});
tasks.push(
...
tasks.push(
function(callback) {
env.getTemplate("sections/particles/ctas.njk", false, "page-sections/text-audio.njk", false, function(t_6,t_5) {
if(t_6) { cb(t_6); return; }
callback(null,t_5);});
});
tasks.push(
...
tasks.push(
function(callback) {
env.getTemplate("sections/particles/text.njk", false, "page-sections/text-icon.njk", false, function(t_2,t_1) {
if(t_2) { cb(t_2); return; }
callback(null,t_1);});
});
tasks.push(
...
tasks.push(
function(callback) {
env.getTemplate("sections/particles/ctas.njk", false, "page-sections/text-icon.njk", false, function(t_6,t_5) {
if(t_6) { cb(t_6); return; }
callback(null,t_5);});
});
tasks.push(
