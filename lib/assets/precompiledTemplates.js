...
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "params")),"leaflet")),"centerX"), env.opts.autoescape);
output += ", ";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "params")),"leaflet")),"centerY"), env.opts.autoescape);
output += "],\n      zoom: ";
...
output += "\"\n        data-centerx=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "section")),"leaflet")),"centerX"), env.opts.autoescape);
output += "\"\n        data-centery=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "section")),"leaflet")),"centerY"), env.opts.autoescape);
output += "\"\n        data-zoom=\"";
